...
class _CreateWalletViewState extends State<CreateWalletView> {
  ...
  BeldexSeedType? _selectedBdxType;
  ...
  Future<Wallet> createWallet(String type, String name, String password) async {
    ...
    try {
      ...
      switch (type) {
        case "beldex":
          if (_selectedBdxType == null) {
            throw Exception("Select seed length!");
          }
          wallet = await BeldexWallet.create(
            path: path,
            password: password,
            seedType: _selectedBdxType!,
                ...
                children: [
                  Expanded(
                    child: DropdownButton(
                      ...
                      isExpanded: true,
                      value: _selectedBdxType,
                      items: [
                        ...BeldexSeedType.values.map(
                          (e) => DropdownMenuItem(
                            value: e,
                            child: Padding(
                      ...
                      onChanged: (value) {
                        setState(() {
                          if (value is BeldexSeedType) {
                            _selectedBdxType = value;
                          }
                        });
                      },
                    ),
