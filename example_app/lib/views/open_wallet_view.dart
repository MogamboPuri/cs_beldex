...
class _OpenWalletViewState extends State<OpenWalletView> {
  Future<List<String>> getAll() async {
    final beldex = await loadWalletNames("beldex");

    return beldex.map((e) => "Beldex:  $e").toList();
  }
...
class _OpenWalletDialogState extends State<OpenWalletDialog> {
  ...
  Future<Wallet> _helperFuture(
    ...
    final daemonAddress = "beldex.stackwallet.com:18081";
        ...
        child: Material(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text("Open \"${widget.name}\" (beldex) wallet"),
