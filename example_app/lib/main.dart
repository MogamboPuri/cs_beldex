...
import 'package:cs_beldex_flutter_libs/cs_beldex_flutter_libs.dart';
...
class _ExampleAppState extends State<ExampleApp> {
  ...
  Future<void> initPlatformState() async {
    ...
    try {
      platformVersion = await CsBeldexFlutterLibs().getPlatformVersion();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('cs_beldex example app'),
        centerTitle: true,
      ),
      body: SafeArea(
        child: Column(
