...
Pointer<Void> getWalletManager() {
  return bindings.BELDEX_WalletManagerFactory_getWalletManager();
}
...
Pointer<Void> createWallet(
  ...
  try {
    return bindings.BELDEX_WalletManager_createWallet(
...
Pointer<Void> openWallet(
  ...
  try {
    return bindings.BELDEX_WalletManager_openWallet(
      walletManagerPointer,
      pathPointer,
      passwordPointer,
      networkType,
...
Pointer<Void> recoveryWallet(
  ...
  try {
    return bindings.BELDEX_WalletManager_recoveryWallet(
      walletManagerPointer,
      pathPointer,
      passwordPointer,
      mnemonicPointer,
...
Pointer<Void> createWalletFromKeys(
  ...
  try {
    return bindings.BELDEX_WalletManager_createWalletFromKeys(
      walletManagerPointer,
      pathPointer,
      passwordPointer,
      languagePointer,
...
Pointer<Void> createDeterministicWalletFromSpendKey(
  ...
  try {
    return bindings.BELDEX_WalletManager_createDeterministicWalletFromSpendKey(
      walletManagerPointer,
      pathPointer,
      passwordPointer,
      languagePointer,
...
Pointer<Void> createWalletFromPolyseed(
  ...
  try {
    return bindings.BELDEX_WalletManager_createWalletFromPolyseed(
      walletManagerPointer,
      pathPointer,
      passwordPointer,
      networkType,
...
bool closeWallet(
  ...
  final closeWallet = bindings.BELDEX_WalletManager_closeWallet(
    walletManagerPointer,
    walletPointer,
    store,
  );
...
bool walletExists(Pointer<Void> walletManagerPointer, String path) {
  ...
  try {
    return bindings.BELDEX_WalletManager_walletExists(
      walletManagerPointer,
      pathPointer,
    );
  } finally {
