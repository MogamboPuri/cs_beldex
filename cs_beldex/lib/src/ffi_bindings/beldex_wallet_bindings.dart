...
import 'beldex_bindings_base.dart';

/// Will throw on failure
void checkWalletStatus(Pointer<Void> walletPointer) {
  final status = bindings.BELDEX_Wallet_status(walletPointer);

  if (status == 0) {
    return;
  }
  final stringPointer = bindings.BELDEX_Wallet_errorString(
    walletPointer,
  ).cast<Utf8>();
...
bool storeWallet(Pointer<Void> walletPointer, {required String path}) {
  ...
  try {
    return bindings.BELDEX_Wallet_store(walletPointer, pathPointer);
  } finally {
...
bool initWallet(
  ...
  try {
    return bindings.BELDEX_Wallet_init(
      walletPointer,
...
void setTrustedDaemon(Pointer<Void> walletPointer, {required bool arg}) {
  bindings.BELDEX_Wallet_setTrustedDaemon(walletPointer, arg);
}

bool isWatchOnly(Pointer<Void> walletPointer) {
  return bindings.BELDEX_Wallet_watchOnly(walletPointer);
}

int isConnected(Pointer<Void> walletPointer) {
  return bindings.BELDEX_Wallet_connected(walletPointer);
}

bool isSynchronized(Pointer<Void> walletPointer) {
  return bindings.BELDEX_Wallet_synchronized(walletPointer);
}

String getWalletPath(Pointer<Void> walletPointer) {
  final stringPointer = bindings.BELDEX_Wallet_path(walletPointer).cast<Utf8>();
...
bool validateAddress(String address, int networkType) {
  ...
  try {
    return bindings.BELDEX_Wallet_addressValid(addressPointer, networkType);
  } finally {
...
String getWalletAddress(
  ...
  final stringPointer = bindings.BELDEX_Wallet_address(
    walletPointer,
    accountIndex,
    addressIndex,
  ).cast<Utf8>();
...
int getWalletBlockChainHeight(Pointer<Void> walletPointer) {
  return bindings.BELDEX_Wallet_blockChainHeight(walletPointer);
}

int getDaemonBlockChainHeight(Pointer<Void> walletPointer) {
  return bindings.BELDEX_Wallet_daemonBlockChainHeight(walletPointer);
}
...
void setWalletRefreshFromBlockHeight(
  ...
  bindings.BELDEX_Wallet_setRefreshFromBlockHeight(
    walletPointer,
...
int getWalletRefreshFromBlockHeight(Pointer<Void> walletPointer) {
  return bindings.BELDEX_Wallet_getRefreshFromBlockHeight(walletPointer);
}
...
void setWalletAutoRefreshInterval(
  ...
  bindings.BELDEX_Wallet_setAutoRefreshInterval(walletPointer, millis);
}

void refreshWalletAsync(Pointer<Void> walletPointer) {
  bindings.BELDEX_Wallet_refreshAsync(walletPointer);
}
...
void stopWallet(Pointer<Void> walletPointer) {
  bindings.BELDEX_Wallet_stop(walletPointer);
}

void rescanWalletBlockchainAsync(Pointer<Void> walletPointer) {
  bindings.BELDEX_Wallet_rescanBlockchainAsync(walletPointer);
}
...
int getWalletBalance(Pointer<Void> walletPointer, {required int accountIndex}) {
  return bindings.BELDEX_Wallet_balance(walletPointer, accountIndex);
}
...
int getWalletUnlockedBalance(
  ...
  return bindings.BELDEX_Wallet_unlockedBalance(walletPointer, accountIndex);
}
...
String getTxKey(Pointer<Void> walletPointer, {required String txid}) {
  ...
  try {
    final stringPointer = bindings.BELDEX_Wallet_getTxKey(
      walletPointer,
      txidPointer,
    ).cast<Utf8>();
    return convertAndFree(stringPointer);
...
Pointer<Void> getTransactionHistoryPointer(Pointer<Void> walletPointer) {
  return bindings.BELDEX_Wallet_history(walletPointer);
}

void refreshTransactionHistory(Pointer<Void> txHistoryPointer) {
  bindings.BELDEX_TransactionHistory_refresh(txHistoryPointer);
}

int getTransactionHistoryCount(Pointer<Void> txHistoryPointer) {
  return bindings.BELDEX_TransactionHistory_count(txHistoryPointer);
}
...
Pointer<Void> getTransactionInfoPointer(
  ...
  return bindings.BELDEX_TransactionHistory_transaction(
    txHistoryPointer,
    index,
  );
}
...
Pointer<Void> getTransactionInfoPointerByTxid(
  ...
  final txidPointer = txid.toNativeUtf8().cast<Char>();
  try {
    return bindings.BELDEX_TransactionHistory_transactionById(
      txHistoryPointer,
      txidPointer,
    );
  } finally {
...
Pointer<Void> createTransaction(
  ...
  try {
    return bindings.BELDEX_Wallet_createTransaction(
      walletPointer,
      addressPointer,
      paymentIdPointer,
      amount,
...
Pointer<Void> createTransactionMultiDest(
  ...
  try {
    return bindings.BELDEX_Wallet_createTransactionMultDest(
      walletPointer,
...
void checkPendingTransactionStatus(Pointer<Void> pendingTransactionPointer) {
  final status = bindings.BELDEX_PendingTransaction_status(
    pendingTransactionPointer,
  );
  if (status == 0) {
    return;
  }
  final stringPointer = bindings.BELDEX_PendingTransaction_errorString(
    pendingTransactionPointer,
  ).cast<Utf8>();
...
int getPendingTransactionAmount(Pointer<Void> pendingTransactionPointer) {
  return bindings.BELDEX_PendingTransaction_amount(pendingTransactionPointer);
}

int getPendingTransactionFee(Pointer<Void> pendingTransactionPointer) {
  return bindings.BELDEX_PendingTransaction_fee(pendingTransactionPointer);
}
...
String getPendingTransactionTxid(
  ...
  try {
    final stringPointer = bindings.BELDEX_PendingTransaction_txid(
      pendingTransactionPointer,
      separatorPointer,
    ).cast<Utf8>();
    return convertAndFree(stringPointer);
...
String getPendingTransactionHex(
  ...
  final separatorPointer = separator.toNativeUtf8().cast<Char>();
  try {
    final stringPointer = bindings.BELDEX_PendingTransaction_hex(
      pendingTransactionPointer,
      separatorPointer,
    ).cast<Utf8>();
    return convertAndFree(stringPointer);
...
bool commitPendingTransaction(
  ...
  try {
    return bindings.BELDEX_PendingTransaction_commit(
      pendingTransactionPointer,
      filenamePointer,
      overwrite,
    );
...
Pointer<Void> getCoinsPointer(Pointer<Void> walletPointer) {
  return bindings.BELDEX_Wallet_coins(walletPointer);
}

void refreshCoins(Pointer<Void> coinsPointer) {
  bindings.BELDEX_Coins_refresh(coinsPointer);
}

int getCoinsCount(Pointer<Void> coinsPointer) {
  return bindings.BELDEX_Coins_count(coinsPointer);
}

int getAllCoinsSize(Pointer<Void> coinsPointer) {
  return bindings.BELDEX_Coins_getAll_size(coinsPointer);
}

Pointer<Void> getCoinInfoPointer(Pointer<Void> coinsPointer, int index) {
  return bindings.BELDEX_Coins_coin(coinsPointer, index);
}

void freezeCoin(Pointer<Void> coinsPointer, {required int index}) {
  bindings.BELDEX_Coins_setFrozen(coinsPointer, index);
}

void thawCoin(Pointer<Void> coinsPointer, {required int index}) {
  bindings.BELDEX_Coins_thaw(coinsPointer, index);
}
...
int getInternalOutputIndexForCoinsInfo(Pointer<Void> coinsInfoPointer) {
  return bindings.BELDEX_CoinsInfo_internalOutputIndex(coinsInfoPointer);
}

bool isFrozenCoinsInfo(Pointer<Void> coinsInfoPointer) {
  return bindings.BELDEX_CoinsInfo_frozen(coinsInfoPointer);
}

bool isSpentCoinsInfo(Pointer<Void> coinsInfoPointer) {
  return bindings.BELDEX_CoinsInfo_spent(coinsInfoPointer);
}

int getSpentHeightForCoinsInfo(Pointer<Void> coinsInfoPointer) {
  return bindings.BELDEX_CoinsInfo_spentHeight(coinsInfoPointer);
}

int getAmountForCoinsInfo(Pointer<Void> coinsInfoPointer) {
  return bindings.BELDEX_CoinsInfo_amount(coinsInfoPointer);
}

int getBlockHeightForCoinsInfo(Pointer<Void> coinsInfoPointer) {
  return bindings.BELDEX_CoinsInfo_blockHeight(coinsInfoPointer);
}

bool isUnlockedCoinsInfo(Pointer<Void> coinsInfoPointer) {
  return bindings.BELDEX_CoinsInfo_unlocked(coinsInfoPointer);
}

bool isCoinbaseCoinsInfo(Pointer<Void> coinsInfoPointer) {
  return bindings.BELDEX_CoinsInfo_coinbase(coinsInfoPointer);
}

String getAddressForCoinsInfo(Pointer<Void> coinsInfoPointer) {
  final stringPointer = bindings.BELDEX_CoinsInfo_address(
    coinsInfoPointer,
  ).cast<Utf8>();
  return convertAndFree(stringPointer);
}
...
String getKeyImageForCoinsInfo(Pointer<Void> coinsInfoPointer) {
  final stringPointer = bindings.BELDEX_CoinsInfo_keyImage(
    coinsInfoPointer,
  ).cast<Utf8>();
  return convertAndFree(stringPointer);
}
...
String getHashForCoinsInfo(Pointer<Void> coinsInfoPointer) {
  final stringPointer = bindings.BELDEX_CoinsInfo_hash(
    coinsInfoPointer,
  ).cast<Utf8>();
  return convertAndFree(stringPointer);
}
...
bool exportWalletKeyImages(
  ...
  final filenamePointer = filename.toNativeUtf8().cast<Char>();
  try {
    return bindings.BELDEX_Wallet_exportKeyImages(
      walletPointer,
      filenamePointer,
      all,
    );
...
bool importWalletKeyImages(Pointer<Void> walletPointer, String filename) {
  ...
  try {
    return bindings.BELDEX_Wallet_importKeyImages(
      walletPointer,
      filenamePointer,
    );
  } finally {
...
String signMessageWith(
  ...
  final addressPointer = address.toNativeUtf8().cast<Char>();
  try {
    final stringPointer = bindings.BELDEX_Wallet_signMessage(
      walletPointer,
      messagePointer,
      addressPointer,
    ).cast<Utf8>();
...
bool verifySignedMessageWithWallet(
  ...
  try {
    return bindings.BELDEX_Wallet_verifySignedMessage(
      walletPointer,
      messagePointer,
      addressPointer,
      signaturePointer,
...
String getWalletSeed(
  ...
  try {
    final stringPointer = bindings.BELDEX_Wallet_seed(
      walletPointer,
      seedOffsetPointer,
    ).cast<Utf8>();
    return convertAndFree(stringPointer);
...
String getWalletSeedLanguage(Pointer<Void> walletPointer) {
  final stringPointer = bindings.BELDEX_Wallet_getSeedLanguage(
    walletPointer,
  ).cast<Utf8>();
  return convertAndFree(stringPointer);
}
...
String getWalletPolyseed(
  ...
  try {
    final stringPointer = bindings.BELDEX_Wallet_getPolyseed(
      walletPointer,
      passphrasePointer,
    ).cast<Utf8>();
    return convertAndFree(stringPointer);
...
String createPolyseed({String language = "English"}) {
  ...
  try {
    final stringPointer = bindings.BELDEX_Wallet_createPolyseed(
...
bool setWalletPassword(
  ...
  try {
    return bindings.BELDEX_Wallet_setPassword(walletPointer, passwordPointer);
  } finally {
...
String getWalletPassword(Pointer<Void> walletPointer) {
  final stringPointer = bindings.BELDEX_Wallet_getPassword(
    walletPointer,
  ).cast<Utf8>();
  return convertAndFree(stringPointer);
}
...
String getWalletSecretViewKey(Pointer<Void> walletPointer) {
  final stringPointer = bindings.BELDEX_Wallet_secretViewKey(
    walletPointer,
  ).cast<Utf8>();
  return convertAndFree(stringPointer);
}
...
String getWalletPublicViewKey(Pointer<Void> walletPointer) {
  final stringPointer = bindings.BELDEX_Wallet_publicViewKey(
    walletPointer,
  ).cast<Utf8>();
  return convertAndFree(stringPointer);
}
...
String getWalletSecretSpendKey(Pointer<Void> walletPointer) {
  final stringPointer = bindings.BELDEX_Wallet_secretSpendKey(
    walletPointer,
  ).cast<Utf8>();
  return convertAndFree(stringPointer);
}
...
String getWalletPublicSpendKey(Pointer<Void> walletPointer) {
  final stringPointer = bindings.BELDEX_Wallet_publicSpendKey(
    walletPointer,
  ).cast<Utf8>();
  return convertAndFree(stringPointer);
}
...
int getTransactionInfoAmount(Pointer<Void> txInfoPointer) {
  return bindings.BELDEX_TransactionInfo_amount(txInfoPointer);
}

int getTransactionInfoFee(Pointer<Void> txInfoPointer) {
  return bindings.BELDEX_TransactionInfo_fee(txInfoPointer);
}

int getTransactionInfoConfirmations(Pointer<Void> txInfoPointer) {
  return bindings.BELDEX_TransactionInfo_confirmations(txInfoPointer);
}

int getTransactionInfoBlockHeight(Pointer<Void> txInfoPointer) {
  return bindings.BELDEX_TransactionInfo_blockHeight(txInfoPointer);
}

int getTransactionInfoTimestamp(Pointer<Void> txInfoPointer) {
  return bindings.BELDEX_TransactionInfo_timestamp(txInfoPointer);
}

int getTransactionInfoAccount(Pointer<Void> txInfoPointer) {
  return bindings.BELDEX_TransactionInfo_subaddrAccount(txInfoPointer);
}

Set<int> getTransactionSubaddressIndexes(Pointer<Void> txInfoPointer) {
  final stringPointer = bindings.BELDEX_TransactionInfo_subaddrIndex(
    txInfoPointer,
    defaultSeparator,
  ).cast<Utf8>();
...
bool getTransactionInfoIsSpend(Pointer<Void> txInfoPointer) {
  ...
  return bindings.BELDEX_TransactionInfo_direction(txInfoPointer) == 1;
}

String getTransactionInfoLabel(Pointer<Void> txInfoPointer) {
  final stringPointer = bindings.BELDEX_TransactionInfo_label(
    txInfoPointer,
  ).cast<Utf8>();
  return convertAndFree(stringPointer);
}
...
String getTransactionInfoDescription(Pointer<Void> txInfoPointer) {
  final stringPointer = bindings.BELDEX_TransactionInfo_description(
    txInfoPointer,
  ).cast<Utf8>();
  return convertAndFree(stringPointer);
}
...
String getTransactionInfoPaymentId(Pointer<Void> txInfoPointer) {
  final stringPointer = bindings.BELDEX_TransactionInfo_paymentId(
    txInfoPointer,
  ).cast<Utf8>();
  return convertAndFree(stringPointer);
}
...
String getTransactionInfoHash(Pointer<Void> txInfoPointer) {
  final stringPointer = bindings.BELDEX_TransactionInfo_hash(
    txInfoPointer,
  ).cast<Utf8>();
  return convertAndFree(stringPointer);
}
...
int amountFromString(String amount) {
  ...
  try {
    return bindings.BELDEX_Wallet_amountFromString(amountPointer);
  } finally {
