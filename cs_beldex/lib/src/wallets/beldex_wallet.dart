...
class BeldexWallet extends Wallet {
  ...
  BeldexWallet._(int pointer, this._worker) : _walletPointer = pointer;
  ...
  /// Creates a new Beldex wallet with the specified parameters and seed type.
  ///
  /// This function initializes a new [BeldexWallet] instance at the specified path
  /// and with the provided password. The type of seed generated depends on the
  /// [BeldexSeedType] parameter. Optionally, it allows creating a deprecated
  ...
  ///   Defaults to `"English"`.
  /// - **seedType** (`BeldexSeedType`, required): Specifies the seed type for the wallet:
  ///   - `sixteen`: 16-word seed (uses polyseed).
  ///   - `twentyFive`: 25-word seed.
  /// - **networkType** (`Network`, required): Specifies the Beldex network type.
  ///
  /// ### Returns:
  /// A `Future` that resolves to an instance of [BeldexWallet] once the wallet
  ...
  ///   seedType: BeldexSeedType.twentyFive,
  ///   networkType: Network.mainnet,
  /// );
  /// ```
  static Future<BeldexWallet> create({
    ...
    switch (seedType) {
      ...
      case BeldexSeedType.twentyFive:
        walletPointerAddress = await worker.runTask(
          Task(
    ...
    final wallet = BeldexWallet._(walletPointerAddress, worker);
    return wallet;
  }

  /// Restores a Beldex wallet from a mnemonic seed phrase.
  ///
  /// ### Parameters:
  ...
  ///
  /// ### Returns:
  /// A `Future` that resolves to an instance of [BeldexWallet] upon successful restoration.
  ///
  /// ### Example:
  /// ```dart
  /// final wallet = await BeldexWallet.restoreWalletFromSeed(
  ///   path: '/path/to/wallet',
  ///   password: 'secure_password',
  ...
  static Future<BeldexWallet> restoreWalletFromSeed({
    required String path,
    required String password,
  ...
  /// Creates a view-only Beldex wallet.
  ///
  /// This function initializes a view-only [BeldexWallet] instance, which allows the
  ...
  ///
  /// ### Returns:
  /// A new instance of [BeldexWallet] with view-only access, allowing tracking
  /// of the specified wallet without spending permissions.
  ///
  /// ### Example:
  /// ```dart
  /// final viewOnlyWallet = BeldexWallet.createViewOnlyWallet(
  ...
  static Future<BeldexWallet> createViewOnlyWallet({
    required String path,
    required String password,
  ...
  /// Restores a Beldex wallet from private keys and address.
  ///
  /// This function creates a new [BeldexWallet] instance from the provided
  ...
  ///
  /// ### Returns:
  /// An instance of [BeldexWallet] representing the restored wallet.
  ///
  /// ### Example:
  /// ```dart
  /// final wallet = BeldexWallet.restoreWalletFromKeys(
  ///   path: '/path/to/wallet',
  ///   password: 'secure_password',
  ///   language: 'English',
  ///   address: 'public_address_here',
  ...
  static Future<BeldexWallet> restoreWalletFromKeys({
    required String path,
    required String password,
  ...
  /// Restores a Beldex wallet and creates a seed from a private spend key.
  ///
  /// ### Parameters:
  /// - **path** (`String`, required): The file path where the wallet will be stored.
  /// - **password** (`String`, required): The password to encrypt the wallet file.
  ...
  /// - **spendKey** (`String`, required): The private spend key associated with the wallet.
  /// - **networkType** (`Network`, optional): Specifies the Beldex network type.
  /// - **restoreHeight** (`int`, optional): The blockchain height from which to start
  ///   synchronizing the wallet. Defaults to `0`, starting from the genesis block.
  ///
  /// ### Returns:
  /// An instance of [BeldexWallet] representing the restored wallet with full access
  /// to the funds associated with the given spend key.
  ///
  /// ### Example:
  /// ```dart
  /// final wallet = BeldexWallet.restoreDeterministicWalletFromSpendKey(
  ///   path: '/path/to/wallet',
  ///   password: 'secure_password',
  ///   language: 'English',
  ///   spendKey: 'spend_key_here',
  ...
  static Future<BeldexWallet> restoreDeterministicWalletFromSpendKey({
    required String path,
    required String password,
    required String language,
    required String spendKey,
  ...
  /// Loads an existing Beldex wallet from the specified path with the provided password.
  ///
  /// ### Parameters:
  ...
  ///
  /// ### Returns:
  /// An instance of [BeldexWallet] representing the loaded wallet.
  ///
  /// ### Example:
  /// ```dart
  /// final wallet = BeldexWallet.loadWallet(
  ...
  static Future<BeldexWallet> loadWallet({
    required String path,
    required String password,
    required Network networkType,
  }) async {
  ...
  int getBlockChainHeightByDate(DateTime date) {
    ...
    return getBeldexHeightByDate(date: date);
  }
  ...
  //   beldex.Wallet_setProxy(_getWalletPointer(), address: proxyUri);
  // }
  ...
  //     return beldex.Wallet_rescanSpent(Pointer.fromAddress(address));
  //   });
  //   return result;
  // }
  ...
  //   final accountsCount =
  //       beldex.Wallet_numSubaddressAccounts(_getWalletPointer());
  //   final accountsPointer =
  //       beldex.Wallet_subaddressAccount(_getWalletPointer());
  //   final accountsSize = beldex.AddressBook_getAll_size(accountsPointer);
  //
  ...
  //       final subaddressCount = beldex.Wallet_numSubaddresses(
  //         _getWalletPointer(),
  //         accountIndex: i,
  //       );
  ...
  //   beldex.Wallet_addSubaddressAccount(_getWalletPointer(), label: label ?? "");
  // }
  //
  // @override
  ...
  //   beldex.Wallet_setSubaddressLabel(
  //     _getWalletPointer(),
