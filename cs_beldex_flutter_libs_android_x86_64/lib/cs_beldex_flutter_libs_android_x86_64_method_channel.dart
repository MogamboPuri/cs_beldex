...
class MethodChannelCsBeldexFlutterLibsAndroidX8664
    extends CsBeldexFlutterLibsAndroidX8664Platform {
  /// The method channel used to interact with the native platform.
  @visibleForTesting
  final methodChannel =
      const MethodChannel('cs_beldex_flutter_libs_android_x86_64');
