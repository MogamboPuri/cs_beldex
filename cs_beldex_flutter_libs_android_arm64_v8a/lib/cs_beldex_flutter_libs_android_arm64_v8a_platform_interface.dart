...
abstract class CsBeldexFlutterLibsAndroidArm64V8aPlatform
  ...
  ///
  /// Defaults to [MethodChannelCsBeldexFlutterLibsAndroidArm64V8a].
  static CsBeldexFlutterLibsAndroidArm64V8aPlatform get instance => _instance;

  /// Platform-specific implementations should set this with their own
  /// platform-specific class that extends [CsBeldexFlutterLibsAndroidArm64V8aPlatform] when
  /// they register themselves.
  static set instance(CsBeldexFlutterLibsAndroidArm64V8aPlatform instance) {
