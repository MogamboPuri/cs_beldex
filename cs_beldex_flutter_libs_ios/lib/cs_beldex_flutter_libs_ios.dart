...
const _channel = MethodChannel('cs_beldex_flutter_libs_ios');

class CsBeldexFlutterLibsIos extends CsBeldexFlutterLibsPlatform {
  /// Registers this class as the default instance of [CsBeldexFlutterLibsPlatform].
  static void registerWith() {
    CsBeldexFlutterLibsPlatform.instance = CsBeldexFlutterLibsIos();
  }
